...
- selftest completo verde: `SUMMARY total=33 pass=33 fail=0`
...
- `include/syscall.h`
- `kernel/syscall.c`
- eventuale nuovo `kernel/futex.c` + `include/futex.h`
...
`make test` verde con nuovi casi multi-thread e almeno un piccolo programma C
musl-linked che crea due thread, usa mutex/cond e termina correttamente.
