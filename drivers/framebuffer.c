...
static const uint8_t font_8x16[][16] = {
    ...
    /* Placeholder per caratteri 36-64: riempiti con pattern semplice */
    /* $ - @ : 36-64 = 29 caratteri */
    [4 ... 32] = {0x00,0x00,0x7E,0x81,0x81,0x81,0x81,0x81,0x81,0x81,0x81,0x7E,0x00,0x00,0x00,0x00},
    /* A (65) */
...
void fb_draw_char(uint32_t x, uint32_t y, char c, uint32_t fg, uint32_t bg)
{
    ...
    if (c < 32 || c > 90) {
        /* Carattere non nel font, disegna un box */
        idx = 0;
    } else {
        idx = c - 32;
    }
